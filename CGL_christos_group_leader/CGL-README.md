...
Equipping the saints; small-group/fellowship leadership formation.
...
- `260222-equipping-the-saints.md` (WordPress post 3485)

## Operating system

See `CGL_operating_system.md` (placeholder; to be developed).
